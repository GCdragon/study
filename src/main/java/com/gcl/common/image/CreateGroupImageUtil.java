...
public class CreateGroupImageUtil
{
    // 图片的间隙
     ...
     * @throws IOException
     */
    public static String createGroupAvatar(List<String> paths, String imagePath) throws IOException
    {
        ...
        g2d.setBackground(new Color(Integer.parseInt("FFFFFF", 16)));
        ...
        ImageIO.write(outImage, HandleImageUtil.IMAGE_FORMATE_PNG, new File(imagePath));
        return imagePath;
    }
